...
namespace TransactionCore.Services.Interface
{
    public interface IReferralService
    {
        ...
        Task<PageResultModel<ReferralActivityResponseModel>> GetReferralActivityAsync(Guid userId, int pageNumber = 1, int pageSize = 10);
        ...
        Task<PageResultModel<ReferralPaymentResponseModel>> GetReferralPaymentsAsync(Guid userId, int pageNumber = 1, int pageSize = 10);
